...
import { getParagraphComments, addParagraphComment, deleteParagraphComment, updateParagraphComment, getChapterParagraphCommentCounts, getChapterAllComments } from '@/app/actions/paragraph-comments'
...
const POPUP_THEME_MAPPING: Record<string, any> = {
  ...
  dark: {
    ...
    text: "text-stone-300",
    button: "hover:bg-stone-850 focus-visible:ring-0",
